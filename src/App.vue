...
<template>
  ...
  ">
        <v-app-bar app color="#163C81" dark>
            <div class="d-flex align-center">
                <v-img alt="ShipSteady Logo" class="shrink mr-2" contain :src="require('./assets/logo.jpg')"
                    transition="scale-transition" max-width="60" />
            </div>
        ...
        <v-container class="pa-0" fill fluid>
            <v-main>
                <template>
                    <v-parallax>
                        <v-responsive class="overflow-y-auto" max-height="600">
                            <v-responsive height="200vh" class="text-center pa-0">
                                ...
                                <v-lazy v-model="isActive" :options="{
                                    ...
                                    <v-card class="mx-auto" max-width="600" color="#163C81" dark elevation="10">
                                        ...
                                        <v-divider></v-divider>
                                        <v-card-subtitle style="background: #1976D2;">Blah blah blahBlah blah blahBlah
                                            blah blah Blah blah blah.</v-card-subtitle>
                                    </v-card>
                                </v-lazy>
                                <v-divider></v-divider>
                                <v-lazy v-model="isActive" :options="{
                                        ...
                                        <v-col>
                                            <template>
                                                <v-card class="rounded-xl mx-auto" max-width="600" color="blue darken-4"
                                                    ...
                                                    <v-divider></v-divider>
                                                    <v-card-subtitle style="background: #1976D2;">Blah blah blahBlah
                                                        blah blah Blah blah blahBlah blah blah.</v-card-subtitle>
                                                </v-card>
                                            </template>
                                        </v-col>
                                    </v-row>
